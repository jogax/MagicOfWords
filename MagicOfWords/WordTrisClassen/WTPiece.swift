...
let myForms: [MyShapes : [(points:[Int], connects:[String])]] = [
    ...
    .L_Shape_3 : [(points:[21, 20, 10, 00], connects: ["0010", "1100", "0001", "0010"]),
                  (points:[02, 12, 11, 10], connects: ["0010", "1100", "0001", "0010"]),
                  (points:[00, 01, 11, 21], connects: ["0010", "1100", "0001", "0010"]),
                  (points:[10, 00, 01, 02], connects: ["0010", "1100", "0001", "0010"])], // OK
    
    .L_Shape_4 : [(points:[20, 21, 11, 01], connects: ["0010", "1100", "0001", "0010"]),
                  (points:[12, 02, 01, 00], connects: ["0010", "1100", "0001", "0010"]),
                  (points:[01, 00, 10, 20], connects: ["0010", "1100", "0001", "0010"]),
                  (points:[00, 10, 11, 12], connects: ["0010", "1100", "0001", "0010"])], // OK
    
    .T_Shape_1 : [(points:[12, 11, 10, 01], connects: ["0010", "1100", "0001", "0010"]),
                    (points:[01, 11, 21, 10], connects: ["0010", "1100", "0001", "0010"]),
                    (points:[00, 01, 02, 11], connects: ["0010", "1100", "0001", "0010"]),
                    (points:[20, 10, 00, 11], connects: ["0010", "1100", "0001", "0010"])],  // OK
    
    .O_Shape_1  : [(points:[00, 01, 11, 10], connects: ["0010", "1100", "0001", "0010"]),
                    (points:[10, 11, 01, 00], connects: ["0010", "1100", "0001", "0010"]),
                    (points:[11, 01, 00, 11], connects: ["0010", "1100", "0001", "0010"]),
                    (points:[01, 00, 10, 11], connects: ["0010", "1100", "0001", "0010"])], // OK
    
    .O_Shape_2  : [(points:[00, 10, 11, 01], connects: ["0010", "1100", "0001", "0010"]),
                    (points:[10, 00, 01, 11], connects: ["0010", "1100", "0001", "0010"]),
                    (points:[11, 10, 00, 01], connects: ["0010", "1100", "0001", "0010"]),
                    (points:[01, 11, 10, 00], connects: ["0010", "1100", "0001", "0010"])], // OK
